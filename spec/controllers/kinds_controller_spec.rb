...
describe KindsController do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved kind as @kind" do
        ...
        post :create, {:kind => { "movie" => movie }}, valid_session
        assigns(:kind).should be_a_new(Kind)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      pending "updates the requested kind" do
        kind = Kind.create! valid_attributes
        ...
        Kind.any_instance.should_receive(:update).with({ "movie" => movie })
        put :update, {:id => kind.to_param, :kind => { "movie" => movie }}, valid_session
      end

      pending "assigns the requested kind as @kind" do
        kind = Kind.create! valid_attributes
        put :update, {:id => kind.to_param, :kind => valid_attributes}, valid_session
        assigns(:kind).should eq(kind)
      end

      pending "redirects to the kind" do
        kind = Kind.create! valid_attributes
        put :update, {:id => kind.to_param, :kind => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      pending "assigns the kind as @kind" do
        kind = Kind.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        Kind.any_instance.stub(:save).and_return(false)
        put :update, {:id => kind.to_param, :kind => { "movie" => movie }}, valid_session
