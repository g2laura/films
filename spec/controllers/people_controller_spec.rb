...
describe PeopleController do
  ...
  let(:valid_attributes) { { "movie" => movie } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved person as @person" do
        ...
        post :create, {:person => { "movie" => "invalid value" }}, valid_session
        assigns(:person).should be_a_new(Person)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      pending "updates the requested person" do
        person = Person.create! valid_attributes
        Person.any_instance.should_receive(:update).with({ "movie" => movie })
        put :update, {:id => person.to_param, :person => { "movie" => movie }}, valid_session
      end

      pending "assigns the requested person as @person" do
        person = Person.create! valid_attributes
        put :update, {:id => person.to_param, :person => valid_attributes}, valid_session
        assigns(:person).should eq(person)
      end

      pending "redirects to the person" do
        person = Person.create! valid_attributes
        put :update, {:id => person.to_param, :person => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      pending "assigns the person as @person" do
        person = Person.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        Person.any_instance.stub(:save).and_return(false)
        put :update, {:id => person.to_param, :person => { "movie" => "invalid value" }}, valid_session
        assigns(:person).should eq(person)
      end
